...
@ControllerAdvice
public class CitizenExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(CitizenException.class)
    public ResponseEntity<Object> standardError(CitizenException e, HttpServletRequest request) {
